 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_support_statistic_total".
 *
 * The followings are the available columns in table 'ommu_support_statistic_total':
 * @property string $statistic_key
 * @property integer $total
 * @property integer $flag
 * @property string $note
 */
class SupportStatisticTotal extends CActiveRecord
{
	 ...
	 * @return SupportStatisticTotal the static model class
	 */
	...
	{
		return 'ommu_support_statistic_total';
	}
	...
	public function search()
	{
		...
		if(!isset($_GET['SupportStatisticTotal_sort']))
