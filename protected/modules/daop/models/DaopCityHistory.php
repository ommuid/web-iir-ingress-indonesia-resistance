 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_daop_city_history".
 *
 * The followings are the available columns in table 'ommu_daop_city_history':
 * @property string $history_id
 * @property string $city_id
 * @property string $modified_date
 * @property string $modified_id
 */
class DaopCityHistory extends CActiveRecord
{
	 ...
	 * @return DaopCityHistory the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('city_id, modified_id', 'required'),
			array('city_id, modified_id', 'length', 'max'=>11),
			array('modified_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('history_id, city_id, modified_date, modified_id,
	...
	public function search()
	{
		...
		if(!isset($_GET['DaopCityHistory_sort']))
