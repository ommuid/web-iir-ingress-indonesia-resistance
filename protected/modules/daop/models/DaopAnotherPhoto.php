 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_daop_another_photo".
 *
 * The followings are the available columns in table 'ommu_daop_another_photo':
 ...
 */
class DaopAnotherPhoto extends CActiveRecord
{
	 ...
	 * @return DaopAnotherPhoto the static model class
	 */
	...
	{
		return 'ommu_daop_another_photo';
	}
	...
	public function rules()
	{
		...
		return array(
			array('publish, another_id, another_photo, modified_id', 'required'),
			array('publish', 'numerical', 'integerOnly'=>true),
			array('another_id, modified_id', 'length', 'max'=>11),
			array('another_photo', 'length', 'max'=>64),
			array('modified_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('photo_id, publish, another_id, another_photo, modified_date, modified_id', 'safe', 'on'=>'search'),
		);
	}
