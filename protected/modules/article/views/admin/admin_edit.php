 ...
 */
	...
	$url = Yii::app()->controller->createUrl('media/ajaxmanage', array('id'=>$model->article_id,'type'=>'admin'));
...
<div class="boxed mt-15">
	<h3><?php echo Phrase::trans(26053,1); ?></h3>
	<div class="clearfix horizontal-data" name="four">
		<ul id="media-render">
			<li id="upload" <?php echo (count(ArticleMedia::getPhoto($model->article_id)) == $setting->media_limit) ? 'class="hide"' : '' ?>>
				<a id="upload-gallery" href="<?php echo Yii::app()->controller->createUrl('media/ajaxadd', array('id'=>$model->article_id,'type'=>'admin'));?>" title="<?php echo Phrase::trans(26054,1); ?>"><?php echo Phrase::trans(26054,1); ?></a>
