 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_user_statistic_total".
 *
 * The followings are the available columns in table 'ommu_user_statistic_total':
 * @property string $statistic_key
 * @property integer $total
 * @property integer $flag
 * @property string $note
 */
class UserStatisticTotal extends CActiveRecord
{
	...
	{
		return 'ommu_user_statistic_total';
	}
