...
class ContentmenuController extends Controller
{
	...
	public function actionManage() 
	{
		...
		$this->pageTitle = Phrase::trans(301,0).$title;
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['OmmuContentMenu'])) {
				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							...
							'msg' => '<div class="errorSummary success"><strong>'.Phrase::trans(212,0).'</strong></div>',
						));
					} else {
			...
			$this->pageTitle = Phrase::trans(208,0);
			$this->pageDescription = '';
			$this->pageMeta = '';
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['OmmuContentMenu'])) {
				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							...
							'get' => Yii::app()->controller->createUrl('manage'),
							'id' => 'partial-contentmenu',
							'msg' => '<div class="errorSummary success"><strong>'.Phrase::trans(211,0).'</strong></div>',
						));
					} else {
						print_r($model->getErrors());
					}
			...
			$this->pageTitle = Phrase::trans(209,0);
			$this->pageDescription = '';
			$this->pageMeta = '';
		...
		if(Yii::app()->request->isPostRequest) {
			...
			if(isset($id)) {
				...
				echo CJSON::encode(array(
					...
					'get' => Yii::app()->controller->createUrl('manage'),
					'id' => 'partial-contentmenu',
					'msg' => '<div class="errorSummary success"><strong>'.Phrase::trans(210,0).'</strong></div>',
				));
			}
			...
			$this->pageTitle = Phrase::trans(207,0);
			$this->pageDescription = '';
			$this->pageMeta = '';
