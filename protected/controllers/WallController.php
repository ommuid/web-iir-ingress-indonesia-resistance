...
class WallController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = OmmuWalls::model()->findByPk(1,array(
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['OmmuWalls'])) {
				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							...
							'msg' => '<div class="errorSummary success"><strong>OmmuWalls success created.</strong></div>',
						));
					} else {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', 'OmmuWalls success created.');
					//$this->redirect(array('view','id'=>$model->wall_id));
					$this->redirect(array('manage'));
				}
			}
		}

		$this->pageTitle = 'Create Ommu Walls';
		$this->pageDescription = '';
		$this->pageMeta = '';
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['OmmuWalls'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', 'OmmuWalls success updated.');
					//$this->redirect(array('view','id'=>$model->wall_id));
					$this->redirect(array('manage'));
				}
			}
