...
class CityController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = DaopCity::model()->findByPk(1,array(
	...
	public function actionView($id) 
	{
		...
		$this->pageTitle = 'View Daop Cities';
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['DaopCity'])) {
				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							...
							'msg' => '<div class="errorSummary success"><strong>DaopCity success created.</strong></div>',
						));
					} else {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', 'DaopCity success created.');
		...
		$this->pageTitle = 'Create Daop Cities';
		$this->pageDescription = '';
		$this->pageMeta = '';
	...
	public function actionRunAction() {
		...
		if(count($id) > 0) {
			...
			if($actions == 'publish') {
				DaopCity::model()->updateAll(array(
					'publish' => 1,
				),$criteria);
				...
				DaopCity::model()->deleteAll($criteria);
			}
		}
			...
			if(isset($id)) {
				...
				if($model->update()) {
					echo CJSON::encode(array(
						...
						'get' => Yii::app()->controller->createUrl('manage'),
						'id' => 'partial-daop-city',
						'msg' => '<div class="errorSummary success"><strong>DaopCity success published.</strong></div>',
					));
				}
			}
